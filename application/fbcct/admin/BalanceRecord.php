...
use app\fbcct\model\BalanceRecordModel as BalanceRecordModel;
 ...
 */
class BalanceRecord extends Admin
{
    /**
     * 用户首页
     * @return mixed
...
// 读取用户数据
        ...
        return ZBuilder::make('table')
            ->setSearch(['uid' => 'UID', "order_id" => "订单号","cid"=>"币种搜索","remark1"=>"备注1搜索"]) // 设置搜索参数
            ->setSearchArea([
                ['daterange', 'date', '日期'],
            ])
            ->addOrder('id')
