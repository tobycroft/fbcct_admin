 ...
 */
class ForumThread extends Admin
{
    /**
     * 用户首页
     * @return mixed
    ...
    public function index()
    {
        ...
        return ZBuilder::make('table')
            ...
            ->addColumn('can_show', '是否显示', 'text.edit')
            ->addColumn('can_transfer', '是否可以转账', 'text.edit')
            ->addColumn('can_transfer_out', '是否可以提现', 'text.edit')
            ->addColumn('can_use', '是否可以交易', 'text.edit')
            ->addColumn('can_exchange', '是否可以闪兑', 'text.edit')
            ->addColumn('transfer_fee', '转账手续费', 'text.edit')
            ->addColumn('transfer_out_fee', '转出手续费', 'text.edit')
            ->addColumn('transfer_limit', '转账限制', 'text.edit')
            ->addColumn('transfer_out_limit', '转出限制', 'text.edit')
            ->addColumn('transfer_per_limit', '单笔转账限制', 'text.edit')
            ->addColumn('transfer_out_per_limit', '单笔转出限制', 'text.edit')
            ->addColumn('transfer_time_limit', '可转账几次', 'text.edit')
