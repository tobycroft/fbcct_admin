...
use app\fbcct\model\Balance as CoinRatioModel;
...
class CoinRatio extends Admin
{
    ...
    public function index()
    {
        ...
        // 读取用户数据
        $data_list = CoinRatioModel::where($map)->order($order)->paginate();
    ...
    public function edit($id = null)
    {
        ...
        // 获取数据
        $info = CoinRatioModel::where('id', $id)->find();
