...
class Rounding extends Admin
{
    ...
    public function index()
    {
        ...
        // 读取用户数据
        $data_list = RoundingModel::where($map)->order($order)->paginate();
...
//            'class' => 'btn btn-xs btn-default ajax-get',
    ...
    public function add()
    {
        ...
        if ($this->request->isPost()) {
            ...
            if ($user = RoundingModel::create($data)) {
    ...
    public function edit($id = null)
    {
        ...
        // 获取数据
        $info = RoundingModel::where('id', $id)->find();
        ...
        return ZBuilder::make('form')
            ...
            ->assign('image_upload_url', url("http://upload.tuuz.cc:81/upfull?token=fbcct", ["data" => "images", "module" => request()->module()]))
